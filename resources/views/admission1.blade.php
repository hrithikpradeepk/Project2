...
@section("content")
    <div class="container"  >
        <div class="row">
          <centre><h2 style="text-align: center; color: white;"> <b>REGISTRATION - WITHOUT CARDIO</b></h2></centre>
                   ...
                   <table class="table " style="height: 350px; width: 500px; margin-left: auto; margin-right: auto; border-color:black;">
                    ...
                    <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                      <form>
                          ...
                          <br>
                          <br>
                          <table class="table " style="height: 300px; width: 600px; margin-left: auto; margin-right: auto; border-color:black;">
